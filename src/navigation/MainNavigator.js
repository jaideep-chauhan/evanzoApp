...
// Search overlay (opened from the Vendors/Gigs search input)
...
const ChatGuarded = withProtectedScreen(
  ChatScreen,
  'Sign in to chat with vendors',
);
const ChatListGuarded = withProtectedScreen(
  ChatList,
  'Sign in to view your messages',
);
const ReviewGuarded = withProtectedScreen(Review, 'Sign in to leave a review');
const SavedVendorsGuarded = withProtectedScreen(
  SavedVendors,
  'Sign in to view your saved vendors',
);
const SettingsGuarded = withProtectedScreen(
  Settings,
  'Sign in to access settings',
);
const SecurityGuarded = withProtectedScreen(
  Security,
  'Sign in to manage security settings',
);
const NotificationsGuarded = withProtectedScreen(
  Notifications,
  'Sign in to manage notification preferences',
);
const PrivacyGuarded = withProtectedScreen(
  Privacy,
  'Sign in to manage privacy settings',
);
const ChangePasswordGuarded = withProtectedScreen(
  ChangePassword,
  'Sign in to change your password',
);
const BlockedUsersGuarded = withProtectedScreen(
  BlockedUsers,
  'Sign in to manage blocked users',
);
const SafetyGuarded = withProtectedScreen(
  Safety,
  'Sign in to access safety controls',
);
const LoginHistoryGuarded = withProtectedScreen(
  LoginHistory,
  'Sign in to view your login history',
);
const ChatInfoGuarded = withProtectedScreen(
  ChatInfoScreen,
  'Sign in to view chat details',
);
const MediaLinksGuarded = withProtectedScreen(
  MediaLinksScreen,
  'Sign in to view shared media',
);
const NotificationInboxGuarded = withProtectedScreen(
  NotificationInbox,
  'Sign in to view your notifications',
);
const UserProfileGuarded = withProtectedScreen(
  UserProfile,
  ...
  return (
    <NavigationContainer ref={navigationRef} linking={linking}>
      <Stack.Navigator
        ...
        <>
          {/* Always-accessible Main shell (Vendors / Gigs / etc.) */}
          ...
          <Stack.Screen
            ...
            component={NotificationInboxGuarded}
          />
          ...
          <Stack.Screen
            name="ChangePassword"
            component={ChangePasswordGuarded}
          />
          ...
          {/* Gig Detail Screen — public browsing */}
          <Stack.Screen
            name="EventDetailView"
            component={EventDetailViewEnhanced}
          />

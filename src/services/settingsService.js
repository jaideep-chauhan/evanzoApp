...
class SettingsService {
  ...
  async getPrivacySettings() {
    try {
      ...
      console.error(
        '[SettingsService] Error fetching privacy settings:',
        error,
      );
  ...
  async updatePrivacySettings(settings) {
    try {
      ...
      console.error(
        '[SettingsService] Error updating privacy settings:',
        error,
      );
      return {
        success: false,
  ...
  async replyToTicket(ticketId, message, attachments = []) {
    try {
      const response = await api.post(
        `/settings/support/tickets/${ticketId}/reply`,
        {
          message,
          attachments,
        },
  ...
  async getTermsAndPolicies() {
    try {
      ...
      console.error(
        '[SettingsService] Error fetching terms and policies:',
        error,
      );
      ...
      return {
        ...
        message:
          error.response?.data?.message ||
          error.message ||
          'Failed to fetch terms and policies',
      };
    }
  }
  ...
  getFallbackFAQs() {
    return [
      ...
      },
      {
        ...
        answer:
          'Go to the vendor\'s profile and click on "Report" button. Fill out the form with details about the issue.',
      },
    ];
  }
}

...
import CustomPhoneInputStyled from '../../components/PhoneInputStyled';
...
export default function LoginWithPhoneScreen() {
    ...
    const handleLogin = async () => {
        ...
        if (inputType === 'phone') {
            loginUsername = formattedPhone || phoneNumber;
        }

        // Validate form using Yup
        const validation = await validateForm(loginSchema, { 
        ...
        setIsLoading(true);
        try {
            // If using phone, send with country code
            const loginData = inputType === 'phone' 
                ? {
                    username: loginUsername,
            ...
            const result = await AuthService.login(loginData.username, password);
                                ...
                                <View style={styles.toggleContainer}>
                                    <TouchableOpacity 
                                        style={[
                                            ...
                                            inputType === 'email' && { backgroundColor: theme.colors.primary }
                                        ]}
                                    ...
                                    <TouchableOpacity 
                                        style={[
                                            ...
                                            inputType === 'phone' && { backgroundColor: theme.colors.primary }
                                        ]}
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    {inputType === 'email' ? (
                                        ...
                                        <CustomPhoneInputStyled
                                            ...
                                            onChangeCountry={({ countryCode, callingCode }) => {
